...
<html>
  <head>
    ...
    <meta name="author" content="Instagram, YcSoocial">
    <link rel="shortcut icon" href="images/favicon/instagram logo.png" type="image/png">
  ...
  <body>
    ...
    <div class="index_header">
      <div class="logo">
        <img src="images/needs/instagram logo 2.png" alt="">
        <hr>
...
<div class="badshah">
  ...
  <div class="about_div inst success_div">
    <img src="<?php echo DIR; ?>/images/needs/instagram logo 2.png" alt="">
    <div class="">
