...
<div class="badshah">
  ...
  <div class="about_div inst thanks_div">
    <img src="<?php echo DIR; ?>/images/needs/instagram logo 2.jpg" alt="">
    <div class="">
      <span>A message has been sent to your email. Check your inbox and click on the link provided in the message to retrieve your account.</span>
    </div>
  </div>
