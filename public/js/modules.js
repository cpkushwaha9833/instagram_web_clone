var DIR = "/ycsocial/instagram-clone";
...
function s(data){
  ...
  if ($('.recomm_main').children().length == 0) {
    $('.recomm_main').html("<div class='home_last_mssg suggest_last_mssg'></div>");
  }
        ...
        $.ajax({
          ...
          success: function(data){
            ...
            if($('.blocked_users').length == 1){
              var ht = "<div class='home_last_mssg pro_last_mssg'><span>No blocked members</span></div>";
              setTimeout(function () {
    ...
    elem.on('click', function(e){
      $.ajax({
        ...
        success: function(data){
          ...
          $('.notifications_header').after("<div class='home_last_mssg pro_last_mssg'><span>You got no notifications</span></div>").hide().slideDown("fast");
