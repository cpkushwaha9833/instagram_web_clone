  ...
  class message {
    ...
    public function conversations(){
      ...
      if ($query->rowCount() > 0) {
        ...
        echo "<div class='home_last_mssg con_last_mssg'>
          <span>No conversations</span></div>";
      }
          ...
          <div class='sli_with'><img src='{$this->DIR}/{$avatar->DisplayAvatar($user)}'>
            ...
            <div class='sli_media'><span class='sli_label'>Media</span>";
              ...
              if ($q->rowCount() > 0) {
                ...
                echo "<div class='home_last_mssg sli_last_mssg'></div>";
              }
            echo "</div>";
    ...
    public function getMessages($con, $user){
      ...
      $query->execute(array(":id" => $con));
        ...
        "<div class='mssg_messages' data-u='{$user}' data-conid='{$con}'><div class='m_m_top'><img src='{$this->DIR}/{$avatar->DisplayAvatar($user)}' alt=''>
            ...
            if ($query->rowCount() == 0) {
              echo "<div class='home_last_mssg mssgs_last_mssg'></div>";
            }
    ...
    public function groupsCon(){
      ...
      if ($query->rowCount() != 0) {
        ...
        echo "<div class='home_last_mssg pro_last_mssg grpp_last_mssg'><span>No group conversation</span></div>";
      }
    }
    ...
    public function selectForGrpConAdmin($grp){
      ...
      $count = $query->rowCount();
      if ($count == 0) {
        echo "<div class='no_display'><img src='{$this->DIR}/images/needs/interpage.jpg'></div>";
      } else if ($count > 0) {
