  ...
  class forgot{
    ...
    public function retrieve($input){
      ...
      if ($scount == 0) {
        ...
        $mail->setFrom($this->gmail, 'Team YcSocial');
        $mail->addAddress($email);               // Name is optional
        $mail->addReplyTo($this->gmail, 'Team YcSocial');
        ...
        $mail->Subject = 'Activate your YcSocial account';

        $mail->Body = "<span>Hello, You received this message because you created an account on YcSocial.<span><br>
        <span>Click on button below to retrieve your YcSocial account and explore.</span><br><br>
